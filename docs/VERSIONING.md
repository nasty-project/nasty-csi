...
- **MAJOR.MINOR.PATCH** (e.g., `v0.15.1`)
- Tags are prefixed with `v` (e.g., `v0.15.1`, `v1.0.0`)
...
2. **Git describe** - For non-tagged commits, format is `v0.15.1-3-gabc1234` (3 commits after v0.15.1)
...
|-------|-------------|---------|
| Version | Semantic version from git tag | `v0.15.1` |
...
```
Starting TNS CSI Driver v0.15.1 (commit: abc1234, built: 2025-12-21T10:30:00Z)
```
...
|-----|-------------|-----------|
| `v0.15.1` | Exact version | Immutable |
...
|------------------|-------|
| `version` | `0.15.1` (chart version, no `v` prefix) |
| `appVersion` | `v0.15.1` (app version, with `v` prefix) |

### Image Tag Resolution

The Helm chart resolves the image tag in this order:

1. **Explicit override**: `--set image.tag=v0.15.1`
2. **Chart's appVersion**: Automatically uses `v0.15.1` when installing `--version 0.15.1`
