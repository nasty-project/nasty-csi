...
# Build Docker image
docker build -t your-registry/tns-csi-driver:v0.16.0 .

# Push to your registry (DockerHub, GitHub Container Registry, etc.)
docker push your-registry/tns-csi-driver:v0.16.0
```

If using a private registry, ensure your Kubernetes cluster has pull access.

The published image is available at: `bfenski/tns-csi:v0.16.0`
...
With:
```yaml
image: your-registry/tns-csi-driver:v0.16.0
```
