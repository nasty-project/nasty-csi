...
# Build Docker image
docker build -t your-registry/tns-csi-driver:v0.15.1 .

# Push to your registry (DockerHub, GitHub Container Registry, etc.)
docker push your-registry/tns-csi-driver:v0.15.1
```

If using a private registry, ensure your Kubernetes cluster has pull access.

The published image is available at: `bfenski/tns-csi:v0.15.1`
...
With:
```yaml
image: your-registry/tns-csi-driver:v0.15.1
```
