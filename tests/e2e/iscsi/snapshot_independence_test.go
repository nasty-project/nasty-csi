...
var _ = Describe("Snapshot Independence", func() {
	...
	It("should create independent snapshot that survives source deletion", func() {
		...
		sourcePVCName := "snap-indep-src-iscsi"
		...
		sourcePodName := "snap-indep-src-pod-iscsi"
		...
		snapshotClassName := "snap-indep-snapclass-iscsi"
		...
		snapshotName := "snap-indep-snap-iscsi"
		...
		GinkgoWriter.Printf("[iSCSI] SUCCESS: Snapshot is independent — survived source volume deletion\n")
	})
})
